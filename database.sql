...
CREATE TABLE Members (
  ...
  SELECT Books.datePublished, Publisher.publisherName FROM Books left JOIN Publisher ON Books.idpublisher = Publisher.idpublisher
  UNION
  SELECT Books.datePublished, Publisher.publisherName FROM Books right JOIN Publisher ON Books.idpublisher = Publisher.idpublisher; 
